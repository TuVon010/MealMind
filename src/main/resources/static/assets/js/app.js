            ...
            <section class="chat-layout">
                ...
                <aside class="grid">
                    <div class="card">
                        ...
                        <div class="chips">
                            ${["早餐想吃方便一点", "晚饭推荐清淡低脂的", "中午想吃点麻辣的", "今天心情一般，想吃点热乎的", "换一批，不想吃刚才那些", "我胃不舒服，应该吃什么"].map((text) => `<button class="chip" data-action="quick-message" data-message="${escapeHtml(text)}">${escapeHtml(text)}</button>`).join("")}
                        </div>
                    </div>
                    <div class="card">
                        <h3>使用提示</h3>
