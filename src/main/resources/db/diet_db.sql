...
-- ----------------------------
-- Table structure for diet_session_memory
-- ----------------------------
DROP TABLE IF EXISTS `diet_session_memory`;
CREATE TABLE `diet_session_memory`  (
  `session_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `diet_user_memory`  (
  ...
  INDEX `idx_user_memory_active`(`user_id` ASC, `active` ASC, `updated_at` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = DYNAMIC;
